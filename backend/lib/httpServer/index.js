...
class HttpServer {
    constructor(node, blockchain, operator, powminer, poetminer, enhancedpoetminer) {
        this.app = express();
        ...
        this.app.post('/miner/mine/pow', (req, res, next) => {
            powminer.mine(req.body.rewardAddress, req.body['feeAddress'] || req.body.rewardAddress)
                .then((newBlock) => {
        ...
        this.app.post('/miner/mine/simplifiedpoet', (req, res, next) => {
            poetminer.mine(req.body.rewardAddress, req.body['feeAddress'] || req.body.rewardAddress)
                .then((newBlock) => {
                    newBlock = Block.fromJson(newBlock);
                    blockchain.addBlock(newBlock);
                    res.status(201).send(newBlock);
        ...
        this.app.post('/miner/mine/enhancedsimplifiedpoet', (req, res, next) => {
            enhancedpoetminer.mine(req.body.rewardAddress, req.body['feeAddress'] || req.body.rewardAddress)
                .then((newBlock) => {
                    newBlock = Block.fromJson(newBlock);
                    blockchain.addBlock(newBlock);
                    res.status(201).send(newBlock);
