...
{ // Transaction
    ...
    "data": {
        "inputs": [ // Transaction inputs
            {
                ...
                "amount": 5000000000, // amount of spartans
        ...
        "outputs": [ // Transaction outputs
            {
                "amount": 10000, // amount of spartans
                "address": "4f8293356d...b53e8c5b25" // to address (64 bytes)
            },
            {
                "amount": 4999989999, // amount of spartans
...
class Transaction {
    ...
    check() {
        ...
        if (this.type == 'regular') {
            ...
            let isEnoughFee = (sumOfInputsAmount - sumOfOutputsAmount) >= Config.FEE_PER_TRANSACTION; // 1 because the fee is 1 spartan per transaction
